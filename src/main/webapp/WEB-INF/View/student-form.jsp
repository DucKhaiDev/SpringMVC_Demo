...
<div class="container">
    ...
    <div>
        ...
        <%--@elvariable id="student" type="com.demo.Model.Student"--%>
        <form:form
                action="${pageContext.request.contextPath}/student/${course.course_id}/save-student"
        ...
        <p>
            <a
                    href="${pageContext.request.contextPath}/student/${course.course_id}/list"
