    ...
    <div>
        <div>
            ...
            <input type="button" value="Add student in this course"
                   onclick="window.location.href='${pageContext.request.contextPath}/student/${course.course_id}/showFormForAdd'; return false;"
            ...
            <table class="table">
                ...
                <c:forEach var="tempStudent" items="${students}">
                    ...
                    <c:url var="updateLink"
                           value="/student/${course.course_id}/showFormForUpdate">
                        <c:param name="studentId" value="${tempStudent.id}" />
                    </c:url>
                    <!-- construct an "delete" link with studentid -->
                    <c:url var="deleteLink" value="/student/${course.course_id}/delete">
                        <c:param name="studentId" value="${tempStudent.id}" />
                    </c:url>
                    <tr>
